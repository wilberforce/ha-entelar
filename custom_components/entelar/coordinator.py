...
class EntelarCoordinator(DataUpdateCoordinator):
    ...
    async def _async_update_data(self) -> dict:
        try:
            ...
            # --- Grid meter (optional device): live power + lifetime registers ---
            # NB: this meter is the inverter's grid-connection meter (the
            # solar-circuit's grid exchange), not the whole-house revenue meter.
            try:
